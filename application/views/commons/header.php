          ...
          <div class="navbar-custom-menu navbar-left">
            <ul class="nav navbar-nav">
				...
				<?php if($mode!="pos"){ ?>
					...
					<?php if(access=="admin"){ ?>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bullhorn"></i> Admin <span class="caret"></span></a>
						<ul class="dropdown-menu" role="menu">
						  <li><a href="<?php echo base_url();?>reports"><i class="fa fa-bars"></i>Reports</a></li>
						</ul>
					</li>
					<?php } ?> 
				<?php } ?>
