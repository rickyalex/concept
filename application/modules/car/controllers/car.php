...
class Car extends MX_Controller
{
    ...
    public function index()
    {
		//if(USER_ID==74){
			...
			$xcrud->relation('to','view_pic_div','dept_code','pic_car');
			...
			// $xcrud->unset_view();
			//$xcrud->set_attr('reporter',array('id'=>'reporter'));//komen
			//$xcrud->set_attr('reporter',array('readOnly'=>'True'));//komen
			
			$xcrud->set_attr('register',array('id'=>'register'));//komen
			$xcrud->set_attr('register',array('readOnly'=>'True'));//komen
			...
			$checklist->columns('description,fotobefore,action,target,pic,result,fotoafter,created_by,date_created,updated_by,last_updated');
			$checklist->relation('pic','view_pic_div','dept_code','pic_car');
			$checklist->label('fotobefore','Keadaan Sebelum');
			$checklist->label('fotoafter','Keadaan Setelah');
			$checklist->change_type('fotobefore','image');
			$checklist->change_type('fotoafter','image');
