...
<section class="content-header">
	<div id="transaction_header" class="row">
		<div class="col-xs-4 col-sm-4 col-md-4">
			...
			<input id="customer_name" name="customer_phone" class="form-control input-sm" style="display:inline-block" type="text" placeholder="Customer Phone" value="<?php if($mode=="update") echo $result['customer_phone']; ?>" <?php if($mode=="update") echo "readonly"; ?>><br>
		</div>
		<div class="col-xs-4 col-sm-4 col-md-4">
