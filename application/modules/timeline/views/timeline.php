...
<!-- Content Wrapper. Contains page content -->
      ...
      <!--ol class="breadcrumb">
           <div class="input-group">
              <input name="q" class="form-control" placeholder="Search Periode..." type="text">
              <span class="input-group-btn">
                <button type="submit" name="keyword" id="search-btn" class="btn btn-flat"><i class="fa fa-search"></i></button>
              </span>
            </div>
          </ol-->
        </section>
