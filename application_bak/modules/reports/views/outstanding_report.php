	...
	<table id="table"
        ...
        <thead>
            <tr>
                ...
                <th data-field="outstanding" data-footer-formatter="sumFormatter1">Outstanding</th>
				<th data-field="total" data-footer-formatter="sumFormatter1">Total</th>
            </tr>
        </thead>
    </table>
...
<script>
    ...
    $('#button_submit').on('click', function (e) {
        ...
        $.ajax({
            type: "POST",
			dataType: 'json',
            url: "<?php echo base_url(); ?>reports/getOutstanding/datefrom/"+datefrom+"/dateto/"+dateto,
