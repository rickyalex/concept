    ...
    <div class='row'>
        ...
        <div class='col-sm-6'>
                <dl class='dl-horizontal'>
                    <dt>Package Price</dt>
                    <dd>
                        <input id='total' name='total' class='form-control' type='text' placeholder='Total price' readonly value="<?php if ($mode == 'update') echo $total; ?>">
                    </dd>
                </dl>
            <dl class='dl-horizontal'>
                    <dt>Package Profit</dt>
                    <dd>
                        <input id='profit' name='profit' class='form-control' type='text' placeholder='Total profit' readonly value="<?php if ($mode == 'update') echo $profit; ?>">
                    </dd>
                </dl>
        </div>
    </div>
